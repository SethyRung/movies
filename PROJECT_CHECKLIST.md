...
- [x] `app/components/media/Top10Section.vue` - Removed style block, using global CSS
- [x] `app/components/media/MediaCardSkeleton.vue` - Converted to global animations
- [x] `app/components/media/MediaRail.vue` - Removed style block
- [x] `app/components/media/HeroSection.vue` - Converted custom CSS to global
...
| File | Issue | Priority |
|------|-------|----------|
| ContentRow.vue | Type mismatches in carousel | Medium |
| HeroSection.vue | FeaturedItem type issues | Medium |
| MediaCard.vue | GSAP TweenTarget issues | Low |
| MediaPosterCard.vue | UButton color type | Low |
| MediaRail.vue | HTMLElement undefined checks | Low |
| Top10Section.vue | UButton color type | Low |
...
│   └── media/
│       ├── MediaPosterCard.vue    # Removed style block
│       ├── Top10Section.vue        # Removed style block
│       ├── MediaCardSkeleton.vue   # Removed style block
│       ├── MediaRail.vue           # Removed style block
│       └── HeroSection.vue         # Removed style block
├── pages/
